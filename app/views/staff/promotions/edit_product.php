<div class="course-form-container">
    <div style="margin-bottom: 30px;">
        <h2 style="font-size: 24px; font-weight: 600; color: #333; margin: 0;">แก้ไขโปรโมชั่นสินค้า</h2>
        <p style="font-size: 14px; color: #888; margin-top: 5px;">แก้ไขส่วนลดและระยะเวลาสำหรับ <?= htmlspecialchars($promo['item_name']) ?></p>
    </div>

    <form method="POST" action="index.php?action=staff_promotion_product_update" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?= $promo['promotion_p_id'] ?>">
